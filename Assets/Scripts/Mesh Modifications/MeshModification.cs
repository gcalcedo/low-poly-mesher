...
/// <summary>
/// Base class for every per-vertex <see cref="VertexData"/> modification.
/// </summary>
public abstract class MeshModification
{
    /// <summary>
    /// Defines the modification to be applied to each <b>Vertex</b> (<see cref="Vector3"/>) of a <see cref="VertexData"/>.
    /// </summary>
