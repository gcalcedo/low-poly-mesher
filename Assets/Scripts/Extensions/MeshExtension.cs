...
public static class MeshExtension
{
    ...
    public static void LoadMeshData(this Mesh mesh, MeshPackage meshData)
    {
        mesh.Clear();
    ...
    /// <summary>
    /// Loads every <see cref="MeshPackage"/> in <paramref name="meshData"/> 
    /// as a submesh of this <see cref="Mesh"/>.
    /// </summary>
    /// <param name="mesh">The mesh on which to load the data.</param>
    /// <param name="meshData">The data of the mesh.</param>
    public static void LoadMeshData(this Mesh mesh, IList<MeshPackage> meshData)
    {
        mesh.Clear();
    ...
    public static void UpdateMeshVertices(this Mesh mesh, IList<MeshPackage> meshData)
    {
        List<Vector3> vertices = new List<Vector3>();
